...
package[money.id] = money;


//点击【背包】切换至背包界面，并生成背包列表
$("#movement_container").on("mousedown","#movement_package",function(){
	movement("package")
	//修改title
	$("#camera_top").html("背包");
